...
(define crystal+capacitor
  (list (capacitor-module 124 82 0   "C1" "22pf" `(net 117 Net-C1-Pad1) `(net 105 GND))
        (capacitor-module 120 78 90  "C2" "22pf" `(net 116 Net-C2-Pad1) `(net 105 GND))
        (crystal-module   124 78 180 "CR" `(net 117 Net-C1-Pad1) `(net 116 Net-C2-Pad1) `(net 105 GND))))
...
(define usb+resistor+fuse
  (list (usb-mini-module 134 32 270 "REF**" `(net 105 GND) `(net 94 Net-USB1-Pad2) `(net 68 D+) `(net 67 D-) `(net 63 VCC))
        (resistor-module 133 55 90  "R2" 22 `(net 104 Net-R2-Pad1) `(net 68 D+))
        (resistor-module 136 55 90  "R3" 22 `(net 103 Net-R3-Pad1) `(net 67 D-))
        (fuse-module     140 55 270 "F1" "500mA" `(net 63 VCC) `(net 102 +5V))))

(define atmega+capacitor+resistor
  (list (atmega-module 135 75 270)
        (capacitor-module 133 64 270 "C3" "1uf"   `(net 106 Net-C3-Pad1) `(net 105 GND))
        (capacitor-module 125 72 90  "C4" "0.1uf" `(net 102 +5V) `(net 105 GND))
        (capacitor-module 131 84 0   "C5" "0.1uf" `(net 102 +5V) `(net 105 GND))
        (capacitor-module 145 80 270 "C6" "0.1uf" `(net 102 +5V) `(net 105 GND))
        (capacitor-module 145 72 90  "C7" "10uf"  `(net 102 +5V) `(net 105 GND))
        (resistor-module  126 67 0   "R1" "10k"   `(net 102 +5V) `(net 113 Net-R1-Pad2))
        (resistor-module  140 84 180 "R4" "10k"   `(net 105 GND) `(net 133 Net-R4-Pad2))))
