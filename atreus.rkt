...
(define atmega-module
  `( module ATMEGA32U4-AU (layer Front) (tedit 0) (tstamp 0)
    ...
    (pad 1 smd rect (at -5.7 -4) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 5 N-col-0))
    (pad 2 smd rect (at -5.7 -3.2) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 102 +5V))
    (pad 3 smd rect (at -5.7 -2.4) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 103 Net-R3-Pad1))
    (pad 4 smd rect (at -5.7 -1.6) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 104 Net-R2-Pad1))
    (pad 5 smd rect (at -5.7 -0.8) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 105 GND))
    (pad 6 smd rect (at -5.7 0) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 106 Net-C3-Pad1))
    (pad 7 smd rect (at -5.7 0.8) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 102 +5V))
    (pad 8 smd rect (at -5.7 1.6) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 108 Net-U1-Pad8))
    (pad 9 smd rect (at -5.7 2.4) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 6 N-col-1))
    (pad 10 smd rect (at -5.7 3.2) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 7 N-col-2))
    (pad 11 smd rect (at -5.7 4) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 8 N-col-3))
    (pad 12 smd rect (at -4 5.7 90) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 9 N-col-4))
    (pad 13 smd rect (at -3.2 5.7 90) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 113 Net-R1-Pad2))
    (pad 14 smd rect (at -2.4 5.7 90) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 102 +5V))
    (pad 15 smd rect (at -1.6 5.7 90) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 105 GND))
    (pad 16 smd rect (at -0.8 5.7 90) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 116 Net-C2-Pad1))
    (pad 17 smd rect (at 0 5.7 90) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 117 Net-C1-Pad1))
    (pad 18 smd rect (at 0.8 5.7 90) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 3 N-row-2))
    (pad 19 smd rect (at 1.6 5.7 90) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 4 N-row-3))
    (pad 20 smd rect (at 2.4 5.7 90) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 120 Net-U1-Pad20))
    (pad 21 smd rect (at 3.2 5.7 90) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 121 Net-U1-Pad21))
    (pad 22 smd rect (at 4 5.7 90) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 122 Net-U1-Pad22))
    (pad 23 smd rect (at 5.7 4) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 105 GND))
    (pad 24 smd rect (at 5.7 3.2) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 102 +5V))
    (pad 25 smd rect (at 5.7 2.4) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 10 N-col-5))
    (pad 26 smd rect (at 5.7 1.6) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 12 N-col-7))
    (pad 27 smd rect (at 5.7 0.8) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 13 N-col-8))
    (pad 28 smd rect (at 5.7 0) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 14 N-col-9))
    (pad 29 smd rect (at 5.7 -0.8) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 15 N-col-10))
    (pad 30 smd rect (at 5.7 -1.6) (size 1.5 0.55) (layers Front F.Paste F.Mask))
    (pad 31 smd rect (at 5.7 -2.4) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 11 N-col-6))
    (pad 32 smd rect (at 5.7 -3.2) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 132 Net-U1-Pad32))
    (pad 33 smd rect (at 5.7 -4) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 133 Net-R4-Pad2))
    (pad 34 smd rect (at 4 -5.7 90) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 102 +5V))
    (pad 35 smd rect (at 3.2 -5.7 90) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 105 GND))
    (pad 36 smd rect (at 2.4 -5.7 90) (size 1.5 0.55) (layers Front F.Paste F.Mask))
    (pad 37 smd rect (at 1.6 -5.7 90) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 1 N-row-0))
    (pad 38 smd rect (at 0.8 -5.7 90) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 2 N-row-1))
    (pad 39 smd rect (at 0 -5.7 90) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 139 Net-U1-Pad39))
    (pad 40 smd rect (at -0.8 -5.7 90) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 140 Net-U1-Pad40))
    (pad 41 smd rect (at -1.6 -5.7 90) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 141 Net-U1-Pad41))
    (pad 42 smd rect (at -2.4 -5.7 90) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 142 Net-U1-Pad42))
    (pad 43 smd rect (at -3.2 -5.7 90) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 105 GND))
    (pad 44 smd rect (at -4 -5.7 90) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 102 +5V))))
...
(define usb+resistor+fuse
  (list (usb-mini-module 134 32 270 "REF**" `(net 105 GND) `(net 94 Net-USB1-Pad2) `(net 68 D+) `(net 67 D-) `(net 63 VCC))
        (resistor-module 122 60 90  "R2" 22 `(net 104 Net-R2-Pad1) `(net 68 D+))
        (resistor-module 125 60 90  "R3" 22 `(net 103 Net-R3-Pad1) `(net 67 D-))
        (fuse-module     140 50 270 "F1" "500mA" `(net 63 VCC) `(net 102 +5V))))
