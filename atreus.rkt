...
(define column-offsets '(11 5 0 6 11 48 48 11 6 0 5 11))
...
(define (crystal-module x y rotation label net-a net-b net-gnd)
  `(module Crystals:Crystal_SMD_3225-4pin_3.2x2.5mm (layer F.Cu) (tedit 58CD2E9C) (tstamp 5CF3B611)
     (at ,x ,y ,rotation)
     ...
     (path /5CEBCEA8)
     (attr smd)
     (fp_text reference Y1 (at 0 2.45 180) (layer F.SilkS) (effects (font (size 1 1) (thickness 0.15))))
     (fp_text value Crystal_GND24_Small (at 0 -2.45 180) (layer F.Fab) (effects (font (size 1 1) (thickness 0.15))))
...
(define (diode-module x y rotation label net-pos net-neg)
  `(module DIODE (layer Front) (tedit 4E0F7A99) (tstamp 543EF854)
     ...
     (path /543DB90F)
     (attr smd)
     (fp_text reference ,label (at 6 0 ,(+ 180 rotation)) (layer F.SilkS) hide (effects (font (size 1.016 1.016) (thickness 0.2032))))
...
(define (atmega-module x y rotation)
  `(module ATMEGA32U4-AU (layer Front) (tedit 0) (tstamp 0)
     (at ,x ,y ,rotation)
     ...
     (attr smd)
     (fp_text reference U1 (at 0 -7.45) (layer F.SilkS) (effects (font (size 1 1) (thickness 0.15))))
     (fp_text value ATmega32U4-AU (at 0 7.45) (layer F.Fab) (effects (font (size 1 1) (thickness 0.15))))
     (fp_text user %R (at 0 0) (layer F.Fab) (effects (font (size 1 1) (thickness 0.15))))
     ...
     (pad 1 smd rect (at -5.7 -4 ,rotation) (size 1.5 0.55) (layers Front F.Paste F.Mask))
     (pad 2 smd rect (at -5.7 -3.2 ,rotation) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 102 +5V))
     (pad 3 smd rect (at -5.7 -2.4 ,rotation) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 103 Net-R3-Pad1))
     (pad 4 smd rect (at -5.7 -1.6 ,rotation) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 104 Net-R2-Pad1))
     (pad 5 smd rect (at -5.7 -0.8 ,rotation) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 105 GND))
     (pad 6 smd rect (at -5.7 0.0 ,rotation) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 106 Net-C3-Pad1))
     (pad 7 smd rect (at -5.7 0.8 ,rotation) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 102 +5V))
     (pad 8 smd rect (at -5.7 1.6 ,rotation) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 108 Net-U1-Pad8))
     (pad 9 smd rect (at -5.7 2.4 ,rotation) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 7 N-col-2))
     (pad 10 smd rect (at -5.7 3.2 ,rotation) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 8 N-col-3))
     (pad 11 smd rect (at -5.7 4.0 ,rotation) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 9 N-col-4))
     (pad 12 smd rect (at -4.0 5.7 ,(- rotation 90)) (size 1.5 0.55) (layers Front F.Paste F.Mask))
     (pad 13 smd rect (at -3.2 5.7 ,(- rotation 90)) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 113 Net-R1-Pad2))
     (pad 14 smd rect (at -2.4 5.7 ,(- rotation 90)) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 102 +5V))
     (pad 15 smd rect (at -1.6 5.7 ,(- rotation 90)) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 105 GND))
     (pad 16 smd rect (at -0.8 5.7 ,(- rotation 90)) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 116 Net-C2-Pad1))
     (pad 17 smd rect (at 0.0 5.7 ,(- rotation 90)) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 117 Net-C1-Pad1))
     (pad 18 smd rect (at 0.8 5.7 ,(- rotation 90)) (size 1.5 0.55) (layers Front F.Paste F.Mask))
     (pad 19 smd rect (at 1.6 5.7 ,(- rotation 90)) (size 1.5 0.55) (layers Front F.Paste F.Mask))
     (pad 20 smd rect (at 2.4 5.7 ,(- rotation 90)) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 120 Net-U1-Pad20))
     (pad 21 smd rect (at 3.2 5.7 ,(- rotation 90)) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 121 Net-U1-Pad21))
     (pad 22 smd rect (at 4.0 5.7 ,(- rotation 90)) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 10 N-col-5))
     (pad 23 smd rect (at 5.7 4.0 ,rotation) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 105 GND))
     (pad 24 smd rect (at 5.7 3.2 ,rotation) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 102 +5V))
     (pad 25 smd rect (at 5.7 2.4 ,rotation) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 5 N-col-0))
     (pad 26 smd rect (at 5.7 1.6 ,rotation) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 6 N-col-1))
     (pad 27 smd rect (at 5.7 0.8 ,rotation) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 11 N-col-6))
     (pad 28 smd rect (at 5.7 0.0 ,rotation) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 12 N-col-7))
     (pad 29 smd rect (at 5.7 -0.8 ,rotation) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 13 N-col-8))
     (pad 30 smd rect (at 5.7 -1.6 ,rotation) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 14 N-col-9))
     (pad 31 smd rect (at 5.7 -2.4 ,rotation) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 15 N-col-10))
     (pad 32 smd rect (at 5.7 -3.2 ,rotation) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 132 Net-U1-Pad32))
     (pad 33 smd rect (at 5.7 -4.0 ,rotation) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 133 Net-R4-Pad2))
     (pad 34 smd rect (at 4.0 -5.7 ,(- rotation 90)) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 102 +5V))
     (pad 35 smd rect (at 3.2 -5.7 ,(- rotation 90)) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 105 GND))
     (pad 36 smd rect (at 2.4 -5.7 ,(- rotation 90)) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 4 N-row-3))
     (pad 37 smd rect (at 1.6 -5.7 ,(- rotation 90)) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 3 N-row-2))
     (pad 38 smd rect (at 0.8 -5.7 ,(- rotation 90)) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 2 N-row-1))
     (pad 39 smd rect (at 0.0 -5.7 ,(- rotation 90)) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 1 N-row-0))
     (pad 40 smd rect (at -0.8 -5.7 ,(- rotation 90)) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 140 Net-U1-Pad40))
     (pad 41 smd rect (at -1.6 -5.7 ,(- rotation 90)) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 141 Net-U1-Pad41))
     (pad 42 smd rect (at -2.4 -5.7 ,(- rotation 90)) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 142 Net-U1-Pad42))
     (pad 43 smd rect (at -3.2 -5.7 ,(- rotation 90)) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 105 GND))
     (pad 44 smd rect (at -4.0 -5.7 ,(- rotation 90)) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 102 +5V))))

(define (capacitor-module x y rotation refer cvalue net-pos net-neg)
  `(module Capacitors_SMD:C_0805 (layer F.Cu) (tedit 58AA8463) (tstamp 5C346F4D)
     (at ,x ,y ,rotation)
...
(define (resistor-module x y rotation refer rvalue net-pos net-neg)
  `(module Resistors_SMD:R_0805 (layer F.Cu) (tedit 58E0A804) (tstamp 5C3454AB)
     ...
     (fp_line (start 1.55 -0.9) (end 1.55 0.9) (layer F.CrtYd) (width 0.05))
     (fp_line (start 1.55 -0.9) (end -1.55 -0.9) (layer F.CrtYd) (width 0.05))
     (pad 1 smd rect (at -0.95 0 ,(+ rotation 90)) (size 0.7 1.3) (layers F.Cu F.Paste F.Mask) ,net-pos)
     (pad 2 smd rect (at 0.95 0 ,(+ rotation 90)) (size 0.7 1.3) (layers F.Cu F.Paste F.Mask) ,net-neg)))

(define (usb-mini-module x y rotation refer net-gnd net-usb net-d+ net-d- net-vcc)
  `(module Molex-0548190589 (layer F.Cu) (tedit 5C494815)
     (at ,x ,y ,rotation)
     (attr smd)
     (fp_text reference ,refer (at 2.032 0 0) (layer F.SilkS) (effects (font (size 1 1) (thickness 0.15))))
     ...
     (fp_line (start 0 -3.85) (end 5.45 -3.85) (layer F.SilkS) (width 0.15))
     (pad 1 smd rect (at 4.5 1.6 ,rotation) (size 2.25 0.5) (layers F.Cu F.Paste F.Mask) ,net-gnd)
     (pad 2 smd rect (at 4.5 0.8 ,rotation) (size 2.25 0.5) (layers F.Cu F.Paste F.Mask) ,net-usb)
     (pad 3 smd rect (at 4.5 0 ,rotation) (size 2.25 0.5) (layers F.Cu F.Paste F.Mask) ,net-d+)
     (pad 4 smd rect (at 4.5 -0.8 ,rotation) (size 2.25 0.5) (layers F.Cu F.Paste F.Mask) ,net-d-)
     (pad 5 smd rect (at 4.5 -1.6 ,rotation) (size 2.25 0.5) (layers F.Cu F.Paste F.Mask) ,net-vcc)
     (pad 6 thru_hole oval (at 4.5 -3.65 ,rotation) (size 2.7 1.7) (drill oval 1.9 0.7) (layers *.Cu *.Mask))
     (pad 6 thru_hole oval (at 4.5 3.65 ,rotation) (size 2.7 1.7) (drill oval 1.9 0.7) (layers *.Cu *.Mask))
...
(define crystal+capacitor
  (list (capacitor-module 124 72 0   "C1" "22pf" `(net 117 Net-C1-Pad1) `(net 105 GND))
        (capacitor-module 120 68 90  "C2" "22pf" `(net 116 Net-C2-Pad1) `(net 105 GND))
        (crystal-module   124 68 180 "CR" `(net 117 Net-C1-Pad1) `(net 116 Net-C2-Pad1) `(net 105 GND))))

(define usb+resistor+fuse
  (list (usb-mini-module 134 32 270 "REF**" `(net 105 GND) `(net 94 Net-USB1-Pad2) `(net 88 D+) `(net 87 D-) `(net 83 VCC))
        (resistor-module 133 45 90  "R2" 22 `(net 104 Net-R2-Pad1) `(net 88 D+))
        (resistor-module 136 45 90  "R3" 22 `(net 103 Net-R3-Pad1) `(net 87 D-))
        (fuse-module     140 45 270 "F1" "500mA" `(net 83 VCC) `(net 102 +5V))))

(define atmega+capacitor+resistor
  (list (atmega-module 135 65 270)
        (capacitor-module 133 54 270 "C3" "1uf"   `(net 106 Net-C3-Pad1) `(net 105 GND))
        (capacitor-module 125 62 90  "C4" "0.1uf" `(net 102 +5V) `(net 105 GND))
        (capacitor-module 131 74 0   "C5" "0.1uf" `(net 102 +5V) `(net 105 GND))
        (capacitor-module 145 70 270 "C6" "0.1uf" `(net 102 +5V) `(net 105 GND))
        (capacitor-module 145 62 90  "C7" "10uf"  `(net 102 +5V) `(net 105 GND))
        (resistor-module  126 57 0   "R1" "10k"   `(net 102 +5V) `(net 113 Net-R1-Pad2))
        (resistor-module  140 74 180 "R4" "10k"   `(net 105 GND) `(net 133 Net-R4-Pad2))))
