...
(define (crystal-module x y rotation label net-a net-b net-gnd)
  `(module Crystals:Crystal_SMD_3225-4pin_3.2x2.5mm (layer B.Cu) (tedit 58CD2E9C) (tstamp 5CF3B611)
     ...
     (path /5CEBCEA8)
     (attr smd)
     (fp_text reference Y1 (at 0 2.45 180) (layer B.SilkS) (effects (font (size 1 1) (thickness 0.15)) (justify mirror)))
     (fp_text value Crystal_GND24_Small (at 0 -2.45 180) (layer B.Fab) (effects (font (size 1 1) (thickness 0.15)) (justify mirror)))
...
(define atmega-module
  `(module ATMEGA32U4-AU (layer F.Cu) (tedit 0)
     ...
     (pad 1 smd rect (at -5.7 4) (size 1.5 0.55) (layers B.Cu B.Paste B.Mask) (net 10 N-col-5))
     ...
     (pad 9 smd rect (at -5.7 -2.4) (size 1.5 0.55) (layers B.Cu B.Paste B.Mask) (net 15 N-col-10))
     (pad 10 smd rect (at -5.7 -3.2) (size 1.5 0.55) (layers B.Cu B.Paste B.Mask) (net 3 N-row-2))
     (pad 11 smd rect (at -5.7 -4) (size 1.5 0.55) (layers B.Cu B.Paste B.Mask) (net 14 N-col-9))
     ...
     (pad 18 smd rect (at 0.8 -5.7 270) (size 1.5 0.55) (layers B.Cu B.Paste B.Mask) (net 8 N-col-3))
     (pad 19 smd rect (at 1.6 -5.7 270) (size 1.5 0.55) (layers B.Cu B.Paste B.Mask) (net 7 N-col-2))
     ...
     (pad 25 smd rect (at 5.7 -2.4) (size 1.5 0.55) (layers B.Cu B.Paste B.Mask) (net 9 N-col-4))
     (pad 26 smd rect (at 5.7 -1.6) (size 1.5 0.55) (layers B.Cu B.Paste B.Mask) (net 126 Net-U1-Pad26))
     (pad 27 smd rect (at 5.7 -0.8) (size 1.5 0.55) (layers B.Cu B.Paste B.Mask) (net 6 N-col-1))
     (pad 28 smd rect (at 5.7 0) (size 1.5 0.55) (layers B.Cu B.Paste B.Mask) (net 1 N-row-0))
     (pad 29 smd rect (at 5.7 0.8) (size 1.5 0.55) (layers B.Cu B.Paste B.Mask) (net 2 N-row-1))
     (pad 30 smd rect (at 5.7 1.6) (size 1.5 0.55) (layers B.Cu B.Paste B.Mask) (net 4 N-row-3))
     (pad 31 smd rect (at 5.7 2.4) (size 1.5 0.55) (layers B.Cu B.Paste B.Mask) (net 5 N-col-0))
     ...
     (pad 36 smd rect (at 2.4 5.7 270) (size 1.5 0.55) (layers B.Cu B.Paste B.Mask) (net 11 N-col-6))
     (pad 37 smd rect (at 1.6 5.7 270) (size 1.5 0.55) (layers B.Cu B.Paste B.Mask) (net 12 N-col-7))
     (pad 38 smd rect (at 0.8 5.7 270) (size 1.5 0.55) (layers B.Cu B.Paste B.Mask) (net 13 N-col-8))
...
(define (capacitor-module x y rotation refer cvalue net-pos net-neg)
  `(module Capacitors_SMD:C_0805 (layer B.Cu) (tedit 58AA8463) (tstamp 5C346F4D)
     ...
     (path /5C341D22)
     (attr smd)
     (fp_text reference ,refer (at 0 1.5 90) (layer B.SilkS) (effects (font (size 1 1) (thickness 0.15)) (justify mirror)))
     (fp_text value ,cvalue (at 0 -1.75 90) (layer B.Fab) (effects (font (size 1 1) (thickness 0.15)) (justify mirror)))
...
(define crystal+capacitor
  (list (capacitor-module  0 0 90  "C1" "22pf" `(net 117 Net-C1-Pad1) `(net 105 GND))
        (capacitor-module 10 0 270 "C2" "22pf" `(net 116 Net-C2-Pad1) `(net 105 GND))
        (crystal-module    5 0 0   "CR" `(net 117 Net-C1-Pad1) `(net 116 Net-C2-Pad1) `(net 105 GND))))
...
(define board
  (apply append nets
         ...
         crystal+capacitor
         (list atmega-module)
         (list (usb-mini-module 134 54 270 "REF**" `(net 105 GND) `(net 94 Net-USB1-Pad2) `(net 68 D+) `(net 67 D-) `(net 63 VCC)))
