...
(define (diode-module x y rotation label net-pos net-neg)
  `(module DIODE (layer Front) (tedit 4E0F7A99) (tstamp 543EF854)
     ...
     (path /543DB90F)
     (attr smd)
     (fp_text reference D2:2 (at 0 0 180) (layer F.SilkS) hide (effects (font (size 1.016 1.016) (thickness 0.2032))))
...
(define atmega-module
  `( module ATMEGA32U4-AU (layer Front) (tedit 0) (tstamp 0)
    ...
    (pad 1 smd rect (at -5.7 -4) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 10 N-col-5))
    ...
    (pad 9 smd rect (at -5.7 2.4) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 15 N-col-10))
    (pad 10 smd rect (at -5.7 3.2) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 3 N-row-2))
    (pad 11 smd rect (at -5.7 4) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 14 N-col-9))
    (pad 12 smd rect (at -4 5.7 90) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 112 Net-U1-Pad12))
    ...
    (pad 18 smd rect (at 0.8 5.7 90) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 8 N-col-3))
    (pad 19 smd rect (at 1.6 5.7 90) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 7 N-col-2))
    ...
    (pad 25 smd rect (at 5.7 2.4) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 9 N-col-4))
    (pad 26 smd rect (at 5.7 1.6) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 126 Net-U1-Pad26))
    (pad 27 smd rect (at 5.7 0.8) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 6 N-col-1))
    (pad 28 smd rect (at 5.7 0) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 1 N-row-0))
    (pad 29 smd rect (at 5.7 -0.8) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 2 N-row-1))
    (pad 30 smd rect (at 5.7 -1.6) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 4 N-row-3))
    (pad 31 smd rect (at 5.7 -2.4) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 5 N-col-0))
    ...
    (pad 36 smd rect (at 2.4 -5.7 90) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 11 N-col-6))
    (pad 37 smd rect (at 1.6 -5.7 90) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 12 N-col-7))
    (pad 38 smd rect (at 0.8 -5.7 90) (size 1.5 0.55) (layers Front F.Paste F.Mask) (net 13 N-col-8))
...
(define (usb-mini-module x y rotation refer net-gnd net-usb net-d+ net-d- net-vcc)
  `(module Molex-0548190589 (layer F.Cu) (tedit 5C494815)
     (at ,x ,y ,rotation)
     (attr smd)
     (fp_text reference ,refer (at 2.032 0 90) (layer F.SilkS) (effects (font (size 1 1) (thickness 0.15))))
...
(define crystal+capacitor
  (list (capacitor-module 135 45 270 "C1" "22pf" `(net 117 Net-C1-Pad1) `(net 105 GND))
