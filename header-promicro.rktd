(kicad_pcb (version 20171130) (host pcbnew "(5.1.2)-2")
  ...
  (gr_text Atreus (at 133.35 87.63) (layer F.SilkS)
    (effects (font (size 4 3) (thickness 0.3048)))
  )
  (gr_text "Phil Hagelberg & Greasy Shit Gang" (at 134.62 109.22) (layer F.SilkS)
  ...
  (gr_text "rev 2.5, Aug. 2019" (at 200.5 101.5 10) (layer F.SilkS)
    (effects (font (size 2.032 1.524) (thickness 0.3048)))
  )
  (gr_text "© 2014 & 2019" (at 135.89 105.41) (layer F.SilkS)
    (effects (font (size 2.032 1.524) (thickness 0.3048)))
  )