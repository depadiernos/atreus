(kicad_pcb (version 20171130) (host pcbnew "(5.1.2)-2")
  ...
  (gr_text GPLv3 (at 68.5 98.5 350) (layer Cmts.User)
    (effects (font (size 1.5 1.1) (thickness 0.2)))
  )
  (gr_text http://atreus.technomancy.us (at 63 100.5 350) (layer Cmts.User)
    (effects (font (size 2.032 1.524) (thickness 0.3048)))
  )
  (gr_text "rev 2.6, Sept. 2019" (at 200.5 101.5 10) (layer Cmts.User)
    (effects (font (size 2.032 1.524) (thickness 0.3048)))
  )