(kicad_pcb (version 20171130) (host pcbnew "(5.1.2)-2")
  ...
  (gr_text GPLv3 (at 64 95 346) (layer Cmts.User)
    (effects (font (size 1.5 1.1) (thickness 0.2)))
  )
  (gr_text http://atreus.technomancy.us (at 64 97 346) (layer Cmts.User)
    (effects (font (size 2.032 1.524) (thickness 0.3048)))
  )
  (gr_text "rev 2.7, Aug. 2020" (at 194.5 95.5 15) (layer Cmts.User)
    (effects (font (size 2.032 1.524) (thickness 0.3048)))
  )