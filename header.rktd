(kicad_pcb (version 20171130) (host pcbnew "(5.1.2)-2")
  ...
  (gr_text Atreus (at 134 67) (layer F.SilkS)
    (effects (font (size 4 3) (thickness 0.3048)))
  )
  (gr_text "Phil Hagelberg\n&\nGreasy Shit Gang" (at 134 77) (layer F.SilkS)
  ...
  (gr_text http://atreus.technomancy.us (at 65 100 346) (layer F.SilkS)
    (effects (font (size 2.032 1.524) (thickness 0.3048)))
  )
  (gr_text "rev 2.7, Feb. 2020" (at 200 100 14) (layer F.SilkS)
    (effects (font (size 2.032 1.524) (thickness 0.3048)))
  )
  (gr_text "© 2014 & 2020" (at 134 86) (layer F.SilkS)
    (effects (font (size 2.032 1.524) (thickness 0.3048)))
  )
